...
from SGST_sentinet_model import SGST
import torch
...
if __name__ == '__main__':
    # 读取数据的路径
    datafile_name = 'senticnetAR_AAPL_data_PCA.csv'
    file_name = './dataset/stockstats&senticnetAR/' + datafile_name
    datatype = 'senticnetAR'
    ...
    for epoch in range(epoch_start_idx, args.num_epochs + 1):
        for step in range(num_batch):
            ...
            pos_logits, seqs = model(y_seq, feature1, feature2, feature3, Positive, Negative)
